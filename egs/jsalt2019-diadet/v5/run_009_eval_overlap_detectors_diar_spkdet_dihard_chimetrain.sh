...
out_dir=${exp_dir}/test_raw_DIHARD-JUN1
...
trn_vec=(CHiME5.SpeakerDiarization.U01 CHiME5.SpeakerDiarization.U01)
val_vec=(CHiME5.SpeakerDiarization.U01.development CHiME5.SpeakerDiarization.U01.development)
